 ...
 * @author Denisse
 */
public class frmCalendarioEstudiantes extends javax.swing.JFrame {

    /**
     * Creates new form frmCalendarioEstudiantes
     */
    public frmCalendarioEstudiantes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setForeground(new java.awt.Color(235, 235, 253));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCalendarioEstudiantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCalendarioEstudiantes().setVisible(true);
            }
        });
    }
